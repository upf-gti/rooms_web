...
panel.sameLine(2);
panel.addButton(null, "Enter Rooms");
...
const footer = new LX.Footer( {
    ...
    credits: `2022-${ new Date().getUTCFullYear() } Pablo L. Garcia, Juan S. Marquerie, Alex Rodríguez. Developed with partial financial support of: MAX-R Project (HORIZON), Wi-XR Project (PID2021-123995NB-I00).`,
    socials: [
